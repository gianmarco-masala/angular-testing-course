...
describe('HomeComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [
        CoursesModule,
        NoopAnimationsModule, // With this import there will be no animations but material components that use animations won't break
      ],
      providers: [
  ...
  it('should display advanced courses when tab clicked - fakeAsync', fakeAsync(() => {
    ...
    // Since an animation is present when switching tabs, it takes some time to complete.
    // So when the code below is being evaluated the animation is not finished yet and test fails.
    // setTimeout(() => {
